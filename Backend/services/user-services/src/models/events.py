...
from sqlalchemy import Column, Integer, String, Boolean, Enum, Text, Date, Time, Interval
...
class Event(BaseEvents):
    ...
    status = Column(Enum("upcoming", "ongoing", "completed", name="event_status"), default="upcoming")
