...
const  Home  = () => {
    ...
    const about_images = ['photo1.jpg', 'photo2.jpg', 'photo3.jpg', 'photo1.jpg', 'photo2.jpg', 'photo3.jpg'];
    const council_images = ['photo1.jpg', 'photo2.jpg', 'photo3.jpg', 'photo1.jpg', 'photo2.jpg', 'photo3.jpg'];
    return (
        <div>
            <Header />
            <Container maxWidth="lg"  alignItems="flex-end">
                <Grid container spacing={2} style={{ marginTop: '20px' }} justifyContent="flex-center" direction="column" wrap="nowrap">
                    <Grid container item xs={12} sx={{ justifyContent: "space-between",'@media (max-width: 600px)': {justifyContent: "space-around",},}} spacing={2} direction="row" justifyContent="space-between">
                        <Grid item xs={6} md={6}>
